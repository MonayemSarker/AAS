...
export function StudentEditInfo() {
    ...
    useEffect(() => {
        Axios.get(`http://localhost:12280/student/${email1}`).then((response) => {
            setPhone(response.data.phoneNum);
            setDob(response.data.sDOB);
    ...
    const handleSubmit = (event) => {
        ...
        Axios.put(`http://localhost:12280/student/${email1}`, studentData)
          .then(response => {
